...
def enigma_process(message, rotor1, rotor2, rotor3, rotor_pos1, rotor_pos2, rotor_pos3, operation, plugboard):
    processed_message = ""
...
operation = st.selectbox("Pilih Operasi", ["Enkripsi", "Dekripsi"])
...
if message:
    if operation == 'Enkripsi':
        processed_message = enigma_process(message, rotor_1, rotor_2, rotor_3, rotor_pos1, rotor_pos2, rotor_pos3, 'encrypt', st.session_state.plugboard)
        st.write("Pesan yang terenkripsi:", processed_message)
    elif operation == 'Dekripsi':
        processed_message = enigma_process(message, rotor_1, rotor_2, rotor_3, rotor_pos1, rotor_pos2, rotor_pos3, 'decrypt', st.session_state.plugboard)
        st.write("Pesan yang terdekripsi:", processed_message)
